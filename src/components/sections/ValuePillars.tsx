    ...
    <section className="py-24" style={{ backgroundColor: "#111111" }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-playfair), serif", color: "#F0F0F0" }}>
          ...
          {pillars.map((pillar) => {
            ...
            return (
              <div
                ...
                onMouseEnter={e => (e.currentTarget.style.borderColor = pillar.accentColor)}
